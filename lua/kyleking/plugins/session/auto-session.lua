...
return {
    ...
    opts = {
        ...
        -- auto_restore_enabled = true, -- FYI: Now handled by the autocmds to workaround lazy
    ...
    init = function()
        ...
        handle_restore_when_lazy_syncs() -- FYI: Required to resolve conflict with lazy.nvim overlay
    end,
    keys = {

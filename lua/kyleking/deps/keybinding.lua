...
later(function()
    ...
    miniclue.setup({
        ...
        clues = {
            ...
            { mode = "n", keys = "<Leader>lwg", desc = "+Go" },
            { mode = "n", keys = "<Leader>lwl", desc = "+Lua" },
            { mode = "n", keys = "<Leader>lwp", desc = "+Python" },
            { mode = "n", keys = "<Leader>lwt", desc = "+TypeScript" },
            ...
            { mode = "n", keys = "<Leader>pa", desc = "+Apply patch" },
            { mode = "n", keys = "<Leader>pz", desc = "+Spelling" },

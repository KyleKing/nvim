...
function Log:init()
    ...
    kyleking_log.kyleking.sinks[1].async = false -- HACK: Bug in structlog prevents setting async to false
    structlog.configure(kyleking_log)
    local logger = structlog.get_logger("kyleking")

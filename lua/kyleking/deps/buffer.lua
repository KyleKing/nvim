...
later(function()
    ...
    K("n", "<leader>bN", function() require("bufjump").forward_same_buf() end, { desc = "Jump next within same buffer" })
    K("n", "<leader>bP", function() require("bufjump").backward_same_buf() end, { desc = "Jump previous within same buffer" })
end)
